                    ...
                    <form action="{{ route('admin/products/update', $products->id) }}" method="POST">
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <textarea name="description" class="form-control" placeholder="Description" rows="4" value="{{$products->description}}"></textarea>
                                @error('description')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <input type="file" name="image" class="form-control" accept="image/*" value="{{$products->images}}">
                                @error('image')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
