...
<body>
    <nav class="navbar">
      <nav class="navbar-left">
        ...
        <h1 class="site-name">UMKM<br>MARGODADI</h1>
      </nav>
        ...
        <div class="left-section">
            ...
            <div class="login-box">
                <div class="container">
                    ...
                    <h2 class="left-section">Login</h2> 
                </div> 
                </div>
                <h3>UMKM<br>DESA MARGODADI</h3>      
                <form action="#">
                    <p>Email Address</p>
                    <input type="text">
                    <p>Password</p>
                    <input type="password">
                    <div class="links">
                        <p>Lupa Password? Silahkan <a href="#">hubungi admin.</a></p>
                    </div>
        ...
        <div class="right-section">
            <div class="box">
              ...
              <div class="info-item">
                ...
                <div class="text">
                  <h4>Or drop us a line</h4>
                  <p>
                    desamargodadijatiagungls@gmail.com<br>
                    0721
                  </p>
                </div>
              </div>
